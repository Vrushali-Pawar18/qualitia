    ...
    return (
        <div className='max-w-6xl mx-auto'>
            {data.textAndImgComps.data.map((textAndImage: any, index: any) => (
                <div key={index} className={`container flex sm:flex-col md:flex-row px-5 py-8 sm:py-24 items-center justify-center ${textAndImage.attributes.textImgData[0].Layout === 'vertical' ? 'flex-col' : 'flex-row'}`}>
